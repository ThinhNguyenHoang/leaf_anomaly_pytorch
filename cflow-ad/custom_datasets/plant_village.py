...
class PlantVillageDataset(Dataset):
    ...
    def load_dataset_folder(self, total_sample_num=TOTAL_SAMPLE_NUM, split_ratios=(0.6, 0.2, 0.2), seed=123):
        ...
        if phase == 'train':
            ...
            self.create_mixed_class_dataset(x,y,mask,healthy_samples,diseased_samples,val_sample_num,0.8,seed=seed+33)
        elif phase == 'test':
            self.create_mixed_class_dataset(x,y,mask,healthy_samples,diseased_samples,test_sample_num,0.8,seed=seed+22)
